...
import * as styles from './LP_MyServicesAccordion.module.scss';
import './LP_MyServicesAccordion.css';
import { Accordion } from 'react-bootstrap';
import { StaticImage } from 'gatsby-plugin-image';
import CustomButton from '../../CustomButton/CustomButton';

const LP_MyServicesAccordion = ({
  title_HTML,
  description_HTML,
  title_web_apps,
...
export default LP_MyServicesAccordion;
