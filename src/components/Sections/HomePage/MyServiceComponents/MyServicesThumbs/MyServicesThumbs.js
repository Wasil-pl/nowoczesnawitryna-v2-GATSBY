              ...
              <div className="mt-[50px] flex flex-col-reverse 2xl:flex-row pl-[20px] ">
                <div className="flex-[60%] tab_content ">
                  ...
                  <p className="text-[1rem] text-text-light mb-[20px] last:mb-[50px]">
                    Oferuję strony interentowe programowane od podstaw, które są unikatowe, w pełni dostosowane do
                    Twoich indywidualnych potrzeb i pozwalają Ci wyróżnić się na tle konkurencji. Moje niestandardowe
                    strony internetowe to coś więcej niż standardowe szablony – każda strona jest tworzona z myślą o
                    wyjątkowym designie i funkcjonalności.
                  </p>
                  <p className="text-[1rem] text-text-light mb-[50px]">
                    Jeśli szukasz nowoczesnej strony internetowej z perfekcyjnym dopasowaniem graficznym (pixel
                    perfect), zaawansowanej aplikacji typu single page app (SPA) lub innego niestandardowego
                    rozwiązania, trafiłeś we właściwe miejsce. Moje strony, spełniają najwyższe standardy zarówno pod
                    względem estetyki, jak i użyteczności.
                  </p>
            ...
            <motion.div variants={variants} animate={tabIndex === 2 ? 'active' : 'hidden'} className="h-full">
              <div className="mt-[50px] flex flex-col-reverse 2xl:flex-row pl-[20px]">
                <div className="flex-[60%] tab_content">
                  ...
                  <p className="text-[1rem] text-text-light mb-[50px]">
                    WordPress to doskonały wybór dla tych, którym zależy na szybkim uruchomieniu strony, przy
                    jednoczesnym zachowaniu pełnej elastyczności i możliwości rozbudowy. Dzięki stronom internetowym na
                    WordPress, zyskasz funkcjonalność, którą łatwo dostosujesz do potrzeb Twojego biznesu.
                  </p>
                  <div className="flex justify-center">
              ...
              <div className="mt-[50px] flex flex-col-reverse 2xl:flex-row pl-[20px]">
                <div className="flex-[60%] tab_content">
                  ...
                  <p className="text-[1rem] text-text-light mb-[20px]">
                    ...
                    rozwiązaniom możesz z łatwością rozwijać swoją sprzedaż online i dostosowywać sklep do potrzeb
                    Twojej firmy.
                  </p>
                  <p className="text-[1rem] text-text-light mb-[50px]">
              ...
              <div className="mt-[50px] flex flex-col-reverse 2xl:flex-row pl-[20px]">
                <div className="flex-[60%] tab_content">
                  ...
                  <p className="text-[1rem] text-text-light mb-[20px]">
                    ...
                    kursami online, uczniami oraz materiałami edukacyjnymi. Moje platformy LMS są idealne dla szkół,
                    firm szkoleniowych oraz osób oferujących kursy online.
                  </p>
                  <p className="text-[1rem] text-text-light mb-[50px]">
                    ...
                    nowe kursy, monitorować postępy uczniów i łatwo zarządzać całą platformą. Tworzone przeze mnie
                    strony są w pełni zoptymalizowane pod kątem SEO, co pozwala dotrzeć do większej liczby odbiorców, a
                    dodatkowo umożliwiają integrację z narzędziami płatności, webinarami i mediami społecznościowymi.
                  </p>
                  <div className="flex justify-center">
