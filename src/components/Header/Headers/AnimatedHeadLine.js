...
export default function AnimatedHeadLine({
  ...
  subtitle = '',
  className = '',
  h1ClassName = 'title text-[6rem] font-extrabold leading-[1.2] tracking-[0.3rem] text-left',
  h2ClassName = 'subtitle text-[1.4rem] lg:text-[1.2rem] md:text-[1rem] leading-[1.3] tracking-[0.15rem] uppercase text-text-light-dark',
  containerClassName = 'content absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-[1200px] grid grid-cols-1 lg:grid-cols-[1fr_300px] items-end gap-8 px-4 text-center lg:text-left',
  lineDuration = 1.1,
  lineStagger = 0.25,
  enterFrom = 'down',
  once = true,
